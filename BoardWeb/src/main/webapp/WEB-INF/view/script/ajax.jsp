...
<div id="register">
  <table class="table">
    <tr>
      <th>아이디</th><td><input class="form-control" type="text" id="uid"></td>
    </tr>
    <tr>
      <th>비밀번호</th><td><input class="form-control" type="password" id="upw"></td>
    </tr>
    <tr>
      <th>이름</th><td><input class="form-control" type="text" id="uname"></td>
    </tr>
    <tr>
      <th>권한</th><td><select id="auth" class="form-control">
